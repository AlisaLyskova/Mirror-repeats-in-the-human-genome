...
int main()
{
    ...
    char chr[] = "chrX";
    if ((fout = fopen("XchrHuman.out","w")) == NULL) { printf(" no out file! "); goto quit; }
    if ((fseq = fopen("XchrHuman.fasta","r")) == NULL) { fprintf(fout," no input file! "); goto quit; }
